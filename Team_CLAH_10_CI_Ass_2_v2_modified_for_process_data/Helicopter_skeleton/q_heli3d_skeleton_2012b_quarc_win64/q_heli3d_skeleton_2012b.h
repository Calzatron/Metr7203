...
typedef struct {
  ...
  real_T Constant_c;                   /* '<S5>/Constant' */
  real_T Constant1_c;                  /* '<S5>/Constant1' */
  real_T Saturation1;                  /* '<Root>/Saturation1' */
  real_T SliderGain_k[2];              /* '<S7>/Slider Gain' */
  ...
  real_T Gain6[2];                     /* '<Root>/Gain6' */
  real_T Sum1[2];                      /* '<Root>/Sum1' */
  real_T TmpSignalConversionAtMeasInport[3];/* '<Root>/3-DOF Plant' */
  ...
  real_T Derivative[3];                /* '<Root>/Derivative' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ErrorbetweenReferenceandActual_;   /* '<Root>/Error between Reference and 'Actual'' */
  ...
  struct {
    void *LoggedData;
  } ReferenceInput_PWORK;              /* '<Root>/Reference Input' */

  struct {
    void *LoggedData;
  } ReferenceInput1_PWORK;             /* '<Root>/Reference Input1' */
  ...
  struct {
    void *LoggedData;
  } rate_est_PWORK;                    /* '<Root>/rate_est' */

  struct {
    void *LoggedData;
  } rate_est1_PWORK;                   /* '<Root>/rate_est1' */
  ...
  struct {
    void *LoggedData;
  } x_hat_angle_PWORK;                 /* '<Root>/x_hat_angle' */

  struct {
    void *LoggedData;
  } x_hat_rates_PWORK;                 /* '<Root>/x_hat_rates' */
  ...
  struct {
    void *LoggedData;
  } y_hat_PWORK;                       /* '<Root>/y_hat' */

  struct {
    void *LoggedData;
  } y_hatelevationandtravel_PWORK;     /* '<Root>/y_hat - elevation and travel' */
...
struct Parameters_q_heli3d_skeleton_20_ {
  ...
  real_T Step_YFinal;                  /* Expression: slope
                                        * Referenced by: '<S4>/Step'
                                        */
  real_T Constant_Value_e;             /* Expression: start
                                        * Referenced by: '<S4>/Constant'
                                        */
  real_T Constant1_Value;              /* Expression: X0
  ...
  real_T Saturation_LowerSat;          /* Expression: -0.5
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T Step_Time_a;                  /* Expression: start
                                        * Referenced by: '<S5>/Step'
                                        */
  real_T Step_Y0_o;                    /* Expression: 0
                                        * Referenced by: '<S5>/Step'
                                        */
  real_T Step_YFinal_o;                /* Expression: slope
                                        * Referenced by: '<S5>/Step'
                                        */
  real_T Constant_Value_k;             /* Expression: start
                                        * Referenced by: '<S5>/Constant'
                                        */
  real_T Constant1_Value_d;            /* Expression: X0
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T Gain3_Gain[12];               /* Expression: K
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Gain6_Gain[12];               /* Expression: C_0
                                        * Referenced by: '<Root>/Gain6'
                                        */
  real_T Gain4_Gain[4];                /* Expression: K_r
  ...
  real_T Gain2_Gain[18];               /* Expression: C
                                        ...
                                        */
  real_T Gain_Gain[12];                /* Expression: B
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T Gain1_Gain_l[36];             /* Expression: A
 ...
 * '<S4>'   : 'q_heli3d_skeleton_2012b/Ramp'
 * '<S5>'   : 'q_heli3d_skeleton_2012b/Ramp1'
 * '<S6>'   : 'q_heli3d_skeleton_2012b/Slider Gain'
 * '<S7>'   : 'q_heli3d_skeleton_2012b/Slider Gain1'
 * '<S8>'   : 'q_heli3d_skeleton_2012b/Desired Angle from Program/Constant: Elevation (deg)'
 * '<S9>'   : 'q_heli3d_skeleton_2012b/Desired Angle from Program/Constant: Travel (deg)'
 * '<S10>'  : 'q_heli3d_skeleton_2012b/Desired Angle from Program/Repeating Sequence'
 * '<S11>'  : 'q_heli3d_skeleton_2012b/Desired Angle from Program/deg to rad'
 * '<S12>'  : 'q_heli3d_skeleton_2012b/Desired Position from Joystick/Convert (-1,1) to (0,1)'
 * '<S13>'  : 'q_heli3d_skeleton_2012b/Desired Position from Joystick/deg to rad'
 */
