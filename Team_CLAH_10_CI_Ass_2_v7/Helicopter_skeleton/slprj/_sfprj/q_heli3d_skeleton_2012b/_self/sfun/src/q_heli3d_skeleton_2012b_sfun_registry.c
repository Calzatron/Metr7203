...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_q_heli3d_skeleton_2012b_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_q_heli3d_skeleton_2012b_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_q_heli3d_skeleton_2012b_process_testpoint_info_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_q_heli3d_skeleton_2012b_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_q_heli3d_skeleton_2012b_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "q_heli3d_skeleton_2012b") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_q_heli3d_skeleton_2012b_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_q_heli3d_skeleton_2012b_get_eml_resolved_functions_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "q_heli3d_skeleton_2012b") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_q_heli3d_skeleton_2012b_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_q_heli3d_skeleton_2012b_method_dispatcher(SimStruct *S,
  ...
  method, void *data)
{
  if (!strcmp(machineName,"q_heli3d_skeleton_2012b")) {
    return(sf_q_heli3d_skeleton_2012b_method_dispatcher(simstructPtr,
...
extern void q_heli3d_skeleton_2012b_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    q_heli3d_skeleton_2012b_terminator();
    sf_debug_terminate();
  }
...
extern void q_heli3d_skeleton_2012b_initializer(void);
extern void q_heli3d_skeleton_2012b_register_exported_symbols(SimStruct* S);
extern void q_heli3d_skeleton_2012b_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  q_heli3d_skeleton_2012b_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      q_heli3d_skeleton_2012b_debug_initialize();
    }

    q_heli3d_skeleton_2012b_initializer();
  }
