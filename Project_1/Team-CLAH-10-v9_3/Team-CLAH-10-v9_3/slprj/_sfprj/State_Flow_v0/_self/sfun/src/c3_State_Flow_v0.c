...
#include <stddef.h>
#include "blas.h"
#include "State_Flow_v0_sfun.h"
#include "c3_State_Flow_v0.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "State_Flow_v0_sfun_debug_macros.h"
...
#define c3_IN_Rest                     ((uint8_T)2U)
#define c3_IN_Swing                    ((uint8_T)3U)
...
static void initialize_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
static void initialize_params_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct *
  chartInstance);
static void enable_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
static void disable_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_State_Flow_v0
  (SFc3_State_Flow_v0InstanceStruct *chartInstance);
static void ext_mode_exec_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_State_Flow_v0
  (SFc3_State_Flow_v0InstanceStruct *chartInstance);
static void set_sim_state_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_State_Flow_v0
  (SFc3_State_Flow_v0InstanceStruct *chartInstance);
static void finalize_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
static void sf_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct *chartInstance);
static void c3_chartstep_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
static void initSimStructsc3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
static void registerMessagesc3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_nargout, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static boolean_T c3_c_emlrt_marshallIn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_is_active_c3_State_Flow_v0, const char_T
  *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static const mxArray *c3_g_emlrt_marshallIn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_h_emlrt_marshallIn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_updateDataWrittenToVector(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, uint32_T c3_vectorIndex);
static void c3_errorIfDataNotWrittenToFcn(SFc3_State_Flow_v0InstanceStruct
  *chartInstance, uint32_T c3_vectorIndex, uint32_T c3_dataNumber);
static void init_dsm_address_info(SFc3_State_Flow_v0InstanceStruct
  *chartInstance);
...
{
  int32_T *c3_sfEvent;
  uint8_T *c3_is_active_c3_State_Flow_v0;
  uint8_T *c3_is_c3_State_Flow_v0;
  c3_is_c3_State_Flow_v0 = (uint8_T *)ssGetDWork(chartInstance->S, 3);
  c3_is_active_c3_State_Flow_v0 = (uint8_T *)ssGetDWork(chartInstance->S, 2);
  c3_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c3_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c3_doSetSimStateSideEffects = 0U;
  chartInstance->c3_setSimStateSideEffectsInfo = NULL;
  *c3_is_active_c3_State_Flow_v0 = 0U;
  *c3_is_c3_State_Flow_v0 = c3_IN_NO_ACTIVE_CHILD;
}
...
static void ext_mode_exec_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct
  *chartInstance)
{
  c3_update_debugger_state_c3_State_Flow_v0(chartInstance);
}
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_y = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
    "y");
  *c3_z = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
    "z");
  *c3_is_active_c3_State_Flow_v0 = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 3)), "is_active_c3_State_Flow_v0");
  *c3_is_c3_State_Flow_v0 = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 4)), "is_c3_State_Flow_v0");
...
static void sf_c3_State_Flow_v0(SFc3_State_Flow_v0InstanceStruct *chartInstance)
{
  int32_T *c3_sfEvent;
  c3_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  c3_set_sim_state_side_effects_c3_State_Flow_v0(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, *c3_sfEvent);
  *c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_State_Flow_v0(chartInstance);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_State_Flow_v0MachineNumber_,
    ...
    switch (*c3_is_c3_State_Flow_v0) {
     case c3_IN_Catch:
      ...
      if (c3_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *c3_sfEvent);
        *c3_is_c3_State_Flow_v0 = c3_IN_Swing;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *c3_sfEvent);
     ...
     case c3_IN_Rest:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_out, 2U, c3_b_sf_marshallOut,
        c3_b_sf_marshallIn);
      guard3 = FALSE;
      if (CV_EML_COND(4, 0, 0, *c3_theta > 0.05)) {
        if (CV_EML_COND(4, 0, 1, *c3_theta_dot > 0.05)) {
     ...
     case c3_IN_Swing:
      ...
      if (CV_EML_COND(2, 0, 0, 2.7475 < *c3_theta)) {
        ...
        if (CV_EML_COND(2, 0, 1, c3_i_hoistedGlobal < 3.5325)) {
      ...
      if (c3_c_out) {
        if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
          ...
          c3_b0 = (*c3_theta < 0.05);
          c3_b1 = (*c3_theta_dot < 0.05);
          c3_d_out = (c3_b0 && c3_b1);
          _SFD_SYMBOL_SCOPE_POP();
          if (c3_d_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *c3_sfEvent);
        *c3_is_c3_State_Flow_v0 = c3_IN_Catch;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *c3_sfEvent);
        ...
        *c3_k_y = 0.0;
        ...
        c3_errorIfDataNotWrittenToFcn(chartInstance, 1U, 1U);
        sf_mex_printf("%s =\\n", "y");
        c3_k_hoistedGlobal = *c3_k_y;
        c3_h_u = c3_k_hoistedGlobal;
        c3_h_y = NULL;
        ...
        *c3_z = 1.0;
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_e_out, 2U, c3_b_sf_marshallOut,
          c3_b_sf_marshallIn);
        guard1 = FALSE;
        if (CV_EML_COND(3, 0, 0, *c3_theta < 0.05)) {
          if (CV_EML_COND(3, 0, 1, *c3_theta_dot < 0.05)) {
        ...
        if (c3_e_out) {
          ...
          *c3_x = 1.0;
          ...
          c3_errorIfDataNotWrittenToFcn(chartInstance, 0U, 0U);
          sf_mex_printf("%s =\\n", "x");
          c3_l_hoistedGlobal = *c3_x;
          c3_i_u = c3_l_hoistedGlobal;
          c3_i_y = NULL;
          ...
          *c3_k_y = 0.0;
          ...
          c3_errorIfDataNotWrittenToFcn(chartInstance, 1U, 1U);
          sf_mex_printf("%s =\\n", "y");
          c3_m_hoistedGlobal = *c3_k_y;
          c3_j_u = c3_m_hoistedGlobal;
          c3_j_y = NULL;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_State_Flow_v0InstanceStruct *chartInstance;
  chartInstance = (SFc3_State_Flow_v0InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_State_Flow_v0_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_is_active_c3_State_Flow_v0), &c3_thisId);
  sf_mex_destroy(&c3_is_active_c3_State_Flow_v0);
  return c3_y;
}
...
void sf_c3_State_Flow_v0_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1234765901U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2701777524U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2537190526U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2668675469U);
}

mxArray *sf_c3_State_Flow_v0_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("1iWFDj642ZN23RifnPare");
...
mxArray *sf_c3_State_Flow_v0_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c3_State_Flow_v0(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[27],T\"x\",},{M[1],M[30],T\"y\",},{M[1],M[28],T\"z\",},{M[8],M[0],T\"is_active_c3_State_Flow_v0\",},{M[9],M[0],T\"is_c3_State_Flow_v0\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_State_Flow_v0_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_State_Flow_v0InstanceStruct *chartInstance;
    chartInstance = (SFc3_State_Flow_v0InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_State_Flow_v0MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_State_Flow_v0MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _State_Flow_v0MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_check_dwork_consistency(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    mxArray *infoStruct = load_State_Flow_v0_optimization_info();
...
static void sf_opaque_initialize_c3_State_Flow_v0(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc3_State_Flow_v0InstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc3_State_Flow_v0InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*)
    chartInstanceVar);
  initialize_c3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_State_Flow_v0(void *chartInstanceVar)
{
  enable_c3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_State_Flow_v0(void *chartInstanceVar)
{
  disable_c3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_State_Flow_v0(void *chartInstanceVar)
{
  sf_c3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c3_State_Flow_v0(void *chartInstanceVar)
{
  ext_mode_exec_c3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_State_Flow_v0(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_State_Flow_v0
    ((SFc3_State_Flow_v0InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_State_Flow_v0();/* state var info */
...
extern void sf_internal_set_sim_state_c3_State_Flow_v0(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_State_Flow_v0(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_State_Flow_v0(S);
}

static void sf_opaque_set_sim_state_c3_State_Flow_v0(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c3_State_Flow_v0(S, st);
}

static void sf_opaque_terminate_c3_State_Flow_v0(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_State_Flow_v0InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_State_Flow_v0_optimization_info();
    }

    finalize_c3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_State_Flow_v0((SFc3_State_Flow_v0InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_State_Flow_v0(SimStruct *S)
{
  int i;
...
mxArray *sf_c3_State_Flow_v0_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S1x2'varName','path'{{T\"is_active_c3_State_Flow_v0\",T\"is_active_c3_State_Flow_v0\"},{T\"is_c3_State_Flow_v0\",T\"is_c3_State_Flow_v0\"}}"
  };
...
static void mdlSetWorkWidths_c3_State_Flow_v0(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_State_Flow_v0_optimization_info();
  ...
  ssSetChecksum0(S,(1379564239U));
  ssSetChecksum1(S,(4120925961U));
  ssSetChecksum2(S,(97424697U));
  ssSetChecksum3(S,(3557166850U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_State_Flow_v0(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_State_Flow_v0(SimStruct *S)
{
  SFc3_State_Flow_v0InstanceStruct *chartInstance;
  chartInstance = (SFc3_State_Flow_v0InstanceStruct *)utMalloc(sizeof
    (SFc3_State_Flow_v0InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_State_Flow_v0InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_State_Flow_v0;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_State_Flow_v0;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_State_Flow_v0;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_State_Flow_v0;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_State_Flow_v0;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_State_Flow_v0;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_State_Flow_v0;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_State_Flow_v0;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_State_Flow_v0;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_State_Flow_v0;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_State_Flow_v0;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c3_State_Flow_v0;
...
void c3_State_Flow_v0_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_State_Flow_v0(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_State_Flow_v0(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_State_Flow_v0(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_State_Flow_v0_method_dispatcher.\n"
