...
RT_MODEL_Resetmdl_T *Resetmdl(void)
{
  ...
  /* External mode info */
  Resetmdl_M->Sizes.checksums[0] = (4161900271U);
  Resetmdl_M->Sizes.checksums[1] = (2794907419U);
  Resetmdl_M->Sizes.checksums[2] = (3055364672U);
  Resetmdl_M->Sizes.checksums[3] = (1358735571U);
