...
MODEL                := Resetmdl
MODULES              := Resetmdl_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Resetmdl.mk
...
#
MODELLIB                  := Resetmdllib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Resetmdl_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);H:/Desktop/Team-CLAH-10-v9_3/Resetmdl_rtwin_win64;H:/Desktop/Team-CLAH-10-v9_3
