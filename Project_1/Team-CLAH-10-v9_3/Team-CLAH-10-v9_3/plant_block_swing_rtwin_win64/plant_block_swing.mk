...
MODEL                := plant_block_swing
MODULES              := plant_block_swing_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := plant_block_swing.mk
...
#
MODELLIB                  := plant_block_swinglib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := plant_block_swing_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);H:/Desktop/Team-CLAH-10-v8/plant_block_swing_rtwin_win64;H:/Desktop/Team-CLAH-10-v8;C:/ECP/m750
