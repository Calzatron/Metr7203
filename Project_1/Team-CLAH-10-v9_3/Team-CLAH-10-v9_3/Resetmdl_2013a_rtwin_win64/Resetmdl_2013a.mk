...
MODEL                := Resetmdl_2013a
MODULES              := Resetmdl_2013a_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Resetmdl_2013a.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2013a
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2013a/bin
S_FUNCTIONS          := ECPDSPReset.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 1
TID01EQ              := 0
...
#
MODELLIB                  := Resetmdl_2013alib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Resetmdl_2013a_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);H:/Desktop/Team-CLAH-10-v8/Resetmdl_2013a_rtwin_win64;H:/Desktop/Team-CLAH-10-v8
