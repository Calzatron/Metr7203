...
MODEL                  = State_Flow_v0
MODULES                = State_Flow_v0_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c 
...
MASTER_ANCHOR_DIR      = 
START_DIR              = H:\Desktop\Team-CLAH-10-v8
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\State_Flow_v0_rsim_rtw

MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)

MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\ECP\m750
