...
typedef struct {
  ...
  real_T FilterCoefficient_k;          /* '<S4>/Filter Coefficient' */
  real_T Sum;                          /* '<S4>/Sum' */
  ...
  real_T IntegralGain_i;               /* '<S4>/Integral Gain' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } GimbleVelocity_PWORK;              /* '<Root>/Gimble Velocity' */
  ...
  struct {
    void *LoggedData;
  } PositionCompensation_PWORK;        /* '<Root>/Position Compensation' */

  struct {
    void *LoggedData;
  } Positionerror1_PWORK;              /* '<Root>/Position error1' */
  ...
  struct {
    void *LoggedData;
  } Table_PWORK;                       /* '<Root>/Table' */

  struct {
    void *LoggedData;
  } Tabledot_PWORK;                    /* '<Root>/Table dot' */
  ...
  uint8_T is_active_c3_plant_block_swing_;/* '<Root>/State Switch v1' */
  uint8_T is_c3_plant_block_swing_catch;/* '<Root>/State Switch v1' */
...
typedef struct {
  ...
  real_T Filter_CSTATE_e;              /* '<S4>/Filter' */
...
typedef struct {
  ...
  boolean_T Filter_CSTATE_e;           /* '<S4>/Filter' */
...
struct P_plant_block_swing_catch_T_ {
  ...
  real_T TransferFcn5_C;               /* Computed Parameter: TransferFcn5_C
                                        * Referenced by: '<Root>/Transfer Fcn5'
                                        */
  real_T Gain2_Gain;                   /* Expression: -15
  ...
  real_T TransferFcn2_C;               /* Computed Parameter: TransferFcn2_C
                                        * Referenced by: '<Root>/Transfer Fcn2'
                                        */
  real_T Gain3_Gain;                   /* Expression: -5.5
  ...
  real_T Constant2_Value;              /* Expression: pi
                                        ...
                                        */
  real_T Gain_Gain;                    /* Expression: -48
  ...
  real_T TransferFcn4_C;               /* Computed Parameter: TransferFcn4_C
                                        * Referenced by: '<Root>/Transfer Fcn4'
                                        */
  real_T Gain1_Gain_j;                 /* Expression: -7
  ...
  real_T TransferFcn1_C;               /* Computed Parameter: TransferFcn1_C
                                        * Referenced by: '<Root>/Transfer Fcn1'
                                        */
  real_T Gain4_Gain_c;                 /* Expression: 1/(1061*32)
                                        * Referenced by: '<Root>/Gain4'
                                        */
  real_T Gain_Gain_l;                  /* Expression: 1/(3882*32)
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T Gain6_Gain;                   /* Expression: 13
  ...
  real_T FixPtUnitDelay1_InitialConditio;/* Expression: vinit
                                          ...
                                          */
  real_T Gain4_Gain_f;                 /* Expression: -435
                                        * Referenced by: '<S6>/Gain4'
                                        */
  real_T Constant1_Value_a;            /* Expression: 7300
                                        * Referenced by: '<S6>/Constant1'
                                        */
  real_T Saturation_UpperSat_p;        /* Expression: 7300
                                        * Referenced by: '<S6>/Saturation'
                                        */
  real_T Saturation_LowerSat_f;        /* Expression: 1400
                                        * Referenced by: '<S6>/Saturation'
                                        */
  ...
  real_T Constant_Value_g;             /* Expression: 1
                                        ...
                                        */
  real_T Gain2_Gain_d;                 /* Expression: 0.1580*9.81*0.2698
  ...
  real_T Saturation1_LowerSat;         /* Expression: -22000
                                        * Referenced by: '<Root>/Saturation1'
                                        */
  real_T Gain3_Gain_b;                 /* Expression: 1/(2546*32)
  ...
  real_T IntegralGain_Gain;            /* Expression: I
                                        ...
                                        */
  real_T IntegralGain_Gain_o;          /* Expression: I
 ...
 * '<S2>'   : 'plant_block_swing_catch/MinMax Running Resettable'
 * '<S3>'   : 'plant_block_swing_catch/PID Controller'
 * '<S4>'   : 'plant_block_swing_catch/PID Controller1'
 * '<S5>'   : 'plant_block_swing_catch/State Switch v1'
 * '<S6>'   : 'plant_block_swing_catch/Subsystem1'
 * '<S7>'   : 'plant_block_swing_catch/Subsystem2'
 * '<S8>'   : 'plant_block_swing_catch/Subsystem1/MinMax Running Resettable'
 * '<S9>'   : 'plant_block_swing_catch/Subsystem1/MinMax Running Resettable/Unit Delay With Preview Resettable'
 */
