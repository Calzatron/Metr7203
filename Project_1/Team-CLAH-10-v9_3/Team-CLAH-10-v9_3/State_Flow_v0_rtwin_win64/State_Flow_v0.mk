...
MODEL                := State_Flow_v0
MODULES              := State_Flow_v0_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := State_Flow_v0.mk
...
#
MODELLIB                  := State_Flow_v0lib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := State_Flow_v0_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);H:/Desktop/Team-CLAH-10-v8/State_Flow_v0_rtwin_win64;H:/Desktop/Team-CLAH-10-v8;C:/ECP/m750
