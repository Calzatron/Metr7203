 ...
 */
#ifndef RTW_HEADER_plant_block_h_
#define RTW_HEADER_plant_block_h_
#ifndef plant_block_COMMON_INCLUDES_
# define plant_block_COMMON_INCLUDES_
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* plant_block_COMMON_INCLUDES_ */

#include "plant_block_types.h"
...
#define plant_block_rtModel            RT_MODEL_plant_block_T
...
#define rtB                            plant_block_B
#define BlockIO                        B_plant_block_T
#define rtX                            plant_block_X
#define ContinuousStates               X_plant_block_T
#define rtXdot                         plant_block_XDot
#define StateDerivatives               XDot_plant_block_T
#define tXdis                          plant_block_XDis
#define StateDisabled                  XDis_plant_block_T
#define rtP                            plant_block_P
#define Parameters                     P_plant_block_T
#define rtDWork                        plant_block_DW
#define D_Work                         DW_plant_block_T

/* Parameters (auto storage) */
struct P_plant_block_T_ {
  ...
  real_T Stepon_Y0;                    /* Expression: 0
                                        * Referenced by: '<Root>/Step on'
                                        */
  real_T Stepon_YFinal;                /* Expression: 15000
                                        * Referenced by: '<Root>/Step on'
                                        */
  real_T Stepoff_Time;                 /* Expression: 30.25
                                        * Referenced by: '<Root>/Step off'
                                        */
  real_T Stepoff_Y0;                   /* Expression: 0
                                        * Referenced by: '<Root>/Step off'
                                        */
  real_T Stepoff_YFinal;               /* Expression: -15000
                                        * Referenced by: '<Root>/Step off'
                                        */
  real_T Stepon1_Time;                 /* Expression: 30.32
                                        * Referenced by: '<Root>/Step on1'
                                        */
  real_T Stepon1_Y0;                   /* Expression: 0
                                        * Referenced by: '<Root>/Step on1'
                                        */
  real_T Stepon1_YFinal;               /* Expression: -30000
                                        * Referenced by: '<Root>/Step on1'
                                        */
  real_T Stepoff1_Time;                /* Expression: 30.57
                                        * Referenced by: '<Root>/Step off1'
                                        */
  real_T Stepoff1_Y0;                  /* Expression: 0
                                        * Referenced by: '<Root>/Step off1'
                                        */
  real_T Stepoff1_YFinal;              /* Expression: 30000
                                        * Referenced by: '<Root>/Step off1'
                                        */
  real_T Gain5_Gain;                   /* Expression: 30/pi
...
extern P_plant_block_T plant_block_P;

/* Block signals (auto storage) */
extern B_plant_block_T plant_block_B;

/* Continuous states (auto storage) */
extern X_plant_block_T plant_block_X;

/* Block states (auto storage) */
extern DW_plant_block_T plant_block_DW;

/* Model entry point functions */
extern RT_MODEL_plant_block_T *plant_block(void);
extern void plant_block_initialize(void);
extern void plant_block_output(void);
extern void plant_block_update(void);
extern void plant_block_terminate(void);

/* Real-time Model object */
extern RT_MODEL_plant_block_T *const plant_block_M;
 ...
 *
 * '<Root>' : 'plant_block'
 * '<S1>'   : 'plant_block/ECPDSP Driver'
 * '<S2>'   : 'plant_block/PID Controller'
 */
#endif                                 /* RTW_HEADER_plant_block_h_ */
