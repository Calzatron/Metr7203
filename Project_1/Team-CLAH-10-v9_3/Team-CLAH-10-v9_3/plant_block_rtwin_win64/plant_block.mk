...
MODEL                := plant_block
MODULES              := plant_block_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := plant_block.mk
...
#
MODELLIB                  := plant_blocklib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := plant_block_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);H:/Desktop/Team-CLAH-10-v3/plant_block_rtwin_win64;H:/Desktop/Team-CLAH-10-v3;C:/ECP/m750
