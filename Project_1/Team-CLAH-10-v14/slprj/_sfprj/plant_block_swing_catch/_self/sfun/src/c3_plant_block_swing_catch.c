    ...
    *c3_r = 0.0;
    ...
    switch (*c3_is_c3_plant_block_swing_catch) {
     case c3_IN_Catch:
      ...
      guard7 = FALSE;
      guard8 = FALSE;
      if (CV_EML_COND(5, 0, 0, *c3_theta_dot > 8.0)) {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4200505024U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1787717399U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4231608749U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2257948729U);
}
...
mxArray *sf_c3_plant_block_swing_catch_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Hv3zm97dS3lH5GDnpg0wc");
...
static void mdlSetWorkWidths_c3_plant_block_swing_catch(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(892637881U));
  ssSetChecksum1(S,(3436592777U));
  ssSetChecksum2(S,(2453627059U));
  ssSetChecksum3(S,(2704585781U));
