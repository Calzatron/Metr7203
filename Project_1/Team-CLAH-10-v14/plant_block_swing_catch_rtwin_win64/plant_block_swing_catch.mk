...
MODEL                := plant_block_swing_catch
MODULES              := plant_block_swing_catch_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c 
MAKEFILE             := plant_block_swing_catch.mk
...
#
MODELLIB                  := plant_block_swing_catchlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := plant_block_swing_catch_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);H:/Desktop/Team-CLAH-10-LateNight_Vol-1/plant_block_swing_catch_rtwin_win64;H:/Desktop/Team-CLAH-10-LateNight_Vol-1;C:/ECP/m750
