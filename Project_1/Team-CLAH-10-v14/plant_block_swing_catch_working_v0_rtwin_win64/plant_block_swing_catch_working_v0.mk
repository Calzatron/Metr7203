...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2013a/bin/win64/gmake"
HOST            = PC
BUILD           = yes
...
MODEL                := plant_block_swing_catch_working_v0
MODULES              := plant_block_swing_catch_working_v0_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c 
MAKEFILE             := plant_block_swing_catch_working_v0.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2013a
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2013a/bin
S_FUNCTIONS          := ECPDSPDriver.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
RTWINDIR             := C:/PROGRA~1/MATLAB/R2013a/toolbox/rtw/targets/rtwin
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := plant_block_swing_catch_working_v0lib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := plant_block_swing_catch_working_v0_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);H:/Desktop/Team-CLAH-10-v13/plant_block_swing_catch_working_v0_rtwin_win64;H:/Desktop/Team-CLAH-10-v13;C:/ECP/m750
